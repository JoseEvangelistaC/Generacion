...
namespace Generacion.Application.Almacen.Query
{
    public class ConsultasAlmacen
    {
        ...
        public ConsultasAlmacen(IConexionBD conexion)
        {
            _conexion = conexion;
        }
        ...
        public async Task<Respuesta<List<ComponenteBujias>>> ObtenerDatosAlmacenBujias(string tipoComponenteID,string sitio)
        {
            ...
            try
            {
                using (OracleConnection connection = _conexion.ObtenerConexion())
                {
                    ...
                    using (OracleCommand command = new OracleCommand("ObtenerComponentesPorTipo", connection))
                    {
                        ...
                        command.Parameters.Add("p_Sitio", OracleDbType.Varchar2).Value = sitio;
        ...
        public async Task<Respuesta<List<PrestamoComponente>>> ObtenerDatosPrestados(string tipoComponenteID, string sitio)
        {
